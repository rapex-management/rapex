...
const AdminForgotPassword = () => {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/proxy/admin/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
                ...
                <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
                  ...
                  <div className="text-center">
                    <h1 className="text-4xl font-bold leading-tight">
                      Secure <span className="inline bg-gradient-to-r from-yellow-200 to-orange-200 bg-clip-text text-transparent">Administrator Account</span> Recovery
                    </h1>
                    <p className="text-xl text-white/90 leading-relaxed max-w-md mt-4">
                      Reset your administrator password securely and regain access to the admin portal.
                    </p>
                  </div>
                  ...
                  <div className="mt-8 space-y-4 w-full max-w-sm">
                    <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-white text-sm">Enhanced Security</h3>
                        <p className="text-white/80 text-xs">Multi-step verification</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-white text-sm">Admin Protection</h3>
                        <p className="text-white/80 text-xs">Secure credential reset</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full lg:w-1/2 flex items-center justify-center p-16 lg:p-20 py-2 lg:py-4">
                <div className="w-full max-w-md space-y-5 h-full flex flex-col justify-center">
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-gray-600 text-sm">Recover access to your admin account</p>
                  </div>
                  ...
                  <div className="border-t border-gray-100 pt-4">
                    <p className="text-center text-sm text-gray-500">
                      <Link href="/admin/login" className="text-orange-600 font-medium hover:text-orange-700">
                        ← Back to Login
                      </Link>
                    </p>
                  </div>
